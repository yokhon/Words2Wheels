def _get_reward(self):
    ...
    TTC_threshold = 2  # larger threshold indicates larger safety zone
    jerk_const = 0.5  # larger jerk_const indicates larger penalty of jerk
    mu = 0.2  # mean of the log time_headway, larger mu indicates larger headway wanted
