def _get_reward(self):
    safety_weight = 0.2012  # larger weight indicates more emphasis on safety
    efficiency_weight = 2.0162  # larger weight indicates more emphasis on efficiency
    comfort_weight = 1.1339  # larger weight indicates more emphasis on comfort
